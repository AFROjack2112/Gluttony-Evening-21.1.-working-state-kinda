...
new Grass(238, 388,25, 30, "./images/cloudtiles/cloud.png", "./images/cloudtiles/cloud.png","./images/cloudtiles/cloud.png", 5,0);

new Grass(100, 250, 25, 30, "./images/stonetiles/stone.png", "./images/stonetiles/stoneleft.png","./images/stonetiles/stoneright.png", 3,0);
...
new Grass(350, 150,50, 60, "./images/grasstiles/vgrass.png", "./images/grasstiles/vgrassbottom.png","./images/grasstiles/vgrasstop.png", 0,7)
new Obstacle(1000, 150,15, 200)
new Obstacle(1100, 150, 200, 15)
...
//Spikes
new Spike(170, 200,25, 30, "./images/spiketiles/spike2.png", "./images/spiketiles/spikeleft.png","./images/spiketiles/spikeright.png", 5,0);
...
new Grass(150, -300, 25, 30, "./images/stonetiles/stone.png", "./images/stonetiles/stoneleft.png","./images/stonetiles/stoneright.png", 3,0);
//top second level
new Grass(150, -1100, 25, 30, "./images/stonetiles/stone.png", "./images/stonetiles/stoneleft.png","./images/stonetiles/stoneright.png", 3,0);


//top 3rd level
new Grass(150, -1900, 25, 30, "./images/stonetiles/stone.png", "./images/stonetiles/stoneleft.png","./images/stonetiles/stoneright.png", 3,0);
...
//floor stone long
new Grass(0, 480, 25, 30, "./images/stonetiles/stone.png", "./images/stonetiles/stoneleft.png","./images/stonetiles/stoneright.png", 100,0);

// new Obstacle(500, 457, 1000, 43);


let floor = new Floor(0,500, 2000,1)
let levelBoundaryLeft = new Obstacle (0,0,20, 500)
...
function startGame(){
	...
	setInterval(function(){hungerBar.getHungrier(0)},50)
...
export{keyEventDown, hungerBar, floor, levelBoundaryLeft, camera, gameOver, myRequest, changeSound}
